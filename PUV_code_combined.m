...
% %% Initial QC
% % PUV_1QC
addpath(genpath('/Users/athinalange/Desktop/IG_BC_remote_work/PUV_Processing-julia/codes'))
addpath(genpath('/Users/athinalange/Desktop/IG_BC_remote_work/PUV_Processing-julia/boundwave'))
addpath(genpath('/Users/athinalange/Desktop/IG_BC_remote_work/PUV_Processing-julia/1stQC'))
...
save('PUV_process.mat', 'PUV_process')
...
%% Mean direction (f)
id = 12%112; %disp(['Selected comparison time is ' datestr(PUV_work.time(1,id)) ' , Hs = ' num2str(Hsig.Hs(id),'%2.2f') 'm'])
