function [etaAa, etaAss, etaAig, frequency, time]= etasolver(pm, tm, interval, varargin)
%% Syntax
...
%% Plotting
% figure
% plot(time(:,sid), etaAa(:,sid)) 
% hold on
% plot(time(:,sid), etaAss(:,sid))
% plot(time(:,sid), etaAig(:,sid))
% legend('All', 'SS', 'IG')
% title('Sea Surface Elevation')

% figure
% subplot(3,1,1)
% plot(time(:,sid), eta2ss(:,sid), 'LineWidth', 2)
% hold on
% plot(time(:,sid), real(etaAss(:,sid)))
% plot(time(:,sid), eta2ss(:,sid) - real(etaAss(:,sid)))
% legend('J', 'A', 'diff')
% title('ss - with dispersion')
% subplot(3,1,2)
% plot(time(:,sid), eta2a(:,sid), 'LineWidth', 2)
% hold on
% plot(time(:,sid), real(etaAa(:,sid)))
% plot(time(:,sid), eta2a(:,sid) - real(etaAa(:,sid)))
% legend('J', 'A', 'diff')
% title('all')
% subplot(3,1,3)
% plot(time(:,sid), eta2ig(:,sid), 'LineWidth', 2)
% hold on
% plot(time(:,sid), real(etaAig(:,sid)))
% plot(time(:,sid), eta2ig(:,sid) - real(etaAig(:,sid)))
% legend('J', 'A', 'diff')
% title('ig')
% 
% figure
